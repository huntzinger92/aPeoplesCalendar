...
export const eventLibrary = {
    ...
    'Revolution': [
      {
        ...
        title: 'Hawaiian Kingdom Overthrown (1893)',
        imgSrc: require('./assets/eventPhotos/Events/hawaiiCoup.jpg'),
        description: `The overthrow of the Hawaiian Kingdom began on this day in 1893 with a coup d'état against Queen Liliʻuokalani by subjects of the Hawaiian Kingdom, United States citizens, and foreign residents residing in Honolulu. A majority of the insurgents were non-natives, and they successfully requested assistance from the U.S. government, who sent 162 sailors to occupy Oahu. The revolutionaries established the Republic of Hawaii, but their ultimate goal was the annexation of the islands to the United States, which occurred in 1898.\n\nThe revolution and subsequent annexation of Hawaii was the beginning of a long period of expansionism from the United States. Just three years later, refused to withdraw troops from Cuba until their government ratified the Platt Amendment, which undermined their newly won independence.\n\nIn 1993, the U.S. government issued an "Apology Resolution", acknowledging that "the overthrow of the Kingdom of Hawaii occurred with the active participation of agents and citizens of the United States and further acknowledges that the Native Hawaiian people never directly relinquished to the United States their claims to their inherent sovereignty as a people over their national lands".`,
        link: 'https://learning.blogs.nytimes.com/2012/01/17/jan-17-1893-hawaiian-monarchy-overthrown-by-america-backed-businessmen/',
        infoSrc: 'https://en.wikipedia.org/wiki/Overthrow_of_the_Hawaiian_Kingdom'
      },
    ],
    'Rebellion': [
      {
  ...
  '3-21': {
    ...
    'Labor': [
      {
        category: 'Labor',
        date: 'March 21st, 1877',
        title: `Farmers' Alliance Founded (1877)`,
        imgSrc: require('./assets/eventPhotos/Organizations/farmersAlliance.jpg'),
        description: `The Farmers Alliance was an organized agrarian economic movement among American farmers that was founded on this day in 1877. The movement was an alliance of several independent farming organizations and a multi-racial coalition. It was heavily associated with the People's Party (known as the "Populist" movement).\n\n The Alliance was formed to combat predation of poor farmers by banks and industrialists in a time of economic hardship for the agricultural industry. In 1889, a bushel of corn had lost 80% of its value from a few decades prior, and 90% of southern farmers relied on credit to survive. Around the same time, it boasted over 400,000 members.\n\nThe Farmers' Alliance collectively bargained for equipment prices, formed a statewide cooperative in Texas to handle the selling of equipment, and advocated for government reforms that would ease the financial burden on farmers, introducing more money into circulation in particular. In 1892, their presidential candidate, James Weaver, received over a million votes. After allying with the Democratic Party, the Alliance and the People's Party collapsed in 1896.`,
        link: 'https://www.historyisaweapon.com/defcon1/zinnbaron11.html',
        infoSrc: 'https://en.wikipedia.org/wiki/Farmers%27_Alliance'
      },
    ],
    'Birthdays': [
      {
  ...
  '4-17': {
    ...
    'Labor': [
      {
        category: 'Labor',
        date: 'April 17th, 1898',
        title: `"A Peace Appeal to Labor" (1898)`,
        imgSrc: require('./assets/eventPhotos/Individuals/boltonHall.jpg'),
        description: `On this day in 1898, Bolton Hall, the treasurer of the American Longshoremen's Union, wrote "A Peace Appeal to Labor". It was written at height of yellow journalism and war fever in the U.S., pushing to intervene in the Cuban struggle for independence against Spain, and urged the working class to not support the coming war. Here is a short excerpt:\n\n"If there is a war, you will furnish the corpses and the taxes, and others will get the glory. Speculators will make money out of it -- that is, out of you.\n\nMen will get high prices for inferior supplies, leaky boats, for shoddy clothes and pasteboard shoes, and you will have to pay the bill, and the only satisfaction you will get is the privilege of hating your Spanish fellow-workmen, who are really your brothers and who have had as little to do with the wrongs of Cuba as you have."`,
        link: 'https://www.historyisaweapon.com/defcon1/zinnempire12.html',
        infoSrc: 'https://books.google.com/books?id=s9r9FqjoX7MC&pg=PA89&lpg=PA89&dq=a+peace+appeal+to+labor+longshoremens&source=bl&ots=PpfTz3OrIu&sig=ACfU3U1PXJo4EYtxZDUm5DNaZNHJF9QO3Q&hl=en&sa=X&ved=2ahUKEwjK0b71zcHqAhVXK80KHRA0Ca4Q6AEwAnoECAYQAQ#v=onepage&q=a%20peace%20appeal%20to%20labor%20longshoremens&f=false'
      },
    ],
    'Birthdays': [
      {
        category: 'Birthdays',
        date: 'April 17th, 1854',
        title: 'Bejamin Tucker (1854 - 1939)',
        imgSrc: require('./assets/eventPhotos/Individuals/benjaminTucker.jpg'),
        description: `Benjamin Ricketson Tucker, born on this day in 1854, was an American anarchist and socialist. Tucker was the editor and publisher of the American individualist anarchist periodical "Liberty" (1881 - 1908) as well as a member of the socialist First International.\n\nTucker harshly opposed state socialism and was a supporter of libertarian socialism and mutualism. His legacy has exerted a strong influence on subsequent anarchist thinkers such as Murray Bookchin, Émile Armand, Kevin A. Carson, and Lev Chernyi.`,
        link: 'https://theanarchistlibrary.org/category/author/benjamin-tucker',
        infoSrc: 'https://en.wikipedia.org/wiki/Benjamin_Tucker'
      },
    ],
    'Assassinations': [
      {
  ...
  '4-21': {
    ...
    'Other': [
      {
        category: 'Other',
        date: 'April 21st, 1898',
        title: 'Spanish-American War Begins (1898)',
        imgSrc: require('./assets/eventPhotos/Events/spanishAmericanWar.jpg'),
        description: `The Spanish-American War was an armed conflict between Spain and the United States that began on this day in 1898, with an American naval blockade of Cuba. Hostilities began in the aftermath of the internal explosion of USS Maine in Havana Harbor in Cuba, leading to U.S. intervention in the Cuban War of Independence. This was the case despite there being no evidence of Spanish involvement in the explosion.\n\nThe outcome of the war resulted in U.S. acquisition of Puerto Rico, Cuba, and the Philippines, and signaled a new era of American expansionism and colonialism in the 20th century.\n\nFrom 1899-1901, the U.S. had to brutally suppress the Filipino movement for independence, killing between 200,000 and 1,000,000 civilians in the Philippine-American War. In 1901, the American government refused to withdraw troops from Cuba unless their Constitutional Convention signed the Platt Amendment, which gave the U.S. government and capital de facto hegemony over newly independent Cuba.`,
        link: 'https://www.thenation.com/article/world/south-china-sea-military/',
        infoSrc: 'https://en.wikipedia.org/wiki/Spanish%E2%80%93American_War'
      },
    ],
  },
  '4-22': {
    ...
    'Labor': [
      {
        category: 'Labor',
        date: 'May 10th, 1898',
        title: 'American Labor Union Founded (1898)',
        imgSrc: require('./assets/eventPhotos/Organizations/americanLaborUnion.jpg'),
        description: `The American Labor Union (ALU) was a radical labor organization that launched as the Western Labor Union (WLU) on this day in 1898. The organization was established by the Western Federation of Miners (WFM) in an effort to build a federation of trade unions in the aftermath of the failed Leadville Miners' Strike of 1896.\n\nAt its peak, the ALU had about 43,000 members, of which 27,000 were members of the WFM. The ALU was an important precursor to the Industrial Workers of the World (IWW), which it helped found in 1905 and was effectively absorbed into.`,
        link: 'https://books.google.com/books?id=gL6Jo33Y-YMC&pg=PA124&lpg=PA124&dq=wlu+salt+lake+city+1898&source=bl&ots=4EPov6fapO&sig=ACfU3U30hqswrbehQbgIkbu4Q0TFmYAz_A&hl=en&sa=X&ved=2ahUKEwim1fD-_8LqAhVEOs0KHepDDSYQ6AEwCXoECAkQAQ#v=onepage&q=wlu%20salt%20lake%20city%201898&f=false',
        infoSrc: 'https://en.wikipedia.org/wiki/American_Labor_Union'
      },
    ],
    'Birthdays': [
      {
    ...
    'Other': [
      {
        category: 'Other',
        date: 'May 18th, 1827',
        title: 'Cincinnati Time Store Opens (1827)',
        imgSrc: require('./assets/eventPhotos/Events/laborNote.jpg'),
        description: `Josiah Warren (1798 - 1874) was an American individualist anarchist, inventor, musician, printer and author. Although he never used the term anarchism himself, Warren is often regarded as the first American anarchist.\n\nOn this day in 1827, he opened the Cincinnati Time Store, which was one of the first experiments of the economic philosophy of mutualism. The store used "labor notes", where the customer purchased a good by agreeing to reproduce the amount of labor time it took to create it, plus a small increase to accomodate the overhead of the store.\n\nAlthough the store was successful, Warren closed it after three years to create two communities based on the same mutualist foundation: Utopia, Ohio and Modern Times, New York. Warren's concepts were influential on later anarchists, such as Benjamin Tucker and Émile Armand.`,
        link: 'https://en.wikipedia.org/wiki/Josiah_Warren',
        infoSrc: 'https://en.wikipedia.org/wiki/Cincinnati_Time_Store'
      },
    ],
  },
  '5-19': {
    ...
    'Other': [
      {
        category: 'Other',
        date: 'July 13th, 1854',
        title: 'Bombardment of Greytown (1854)',
        imgSrc: require('./assets/eventPhotos/Events/bombardmentOfGreytown.jpg'),
        description: `The Bombardment of Greytown or the Bombardment of San Juan del Norte was a naval action initiated by the United States warship USS Cyane against the town of Greytown in the Miskito Kingdom (modern day Nicaragua). The town was completely destroyed by massive fires set by marines who came ashore. The attack was in response to attempts by the British govenrment to charge taxes on ships that used the town as a port, among other grievances.\n\nIn response to international outrage regarding the incident, president Franklin Pierce issued a statement acknowledging that, while it would have been more satisfactory if the Cyane's mission could have been consummated without the use of force, "the arrogant contumacy of the offenders rendered it impossible to avoid the alternative either to break up their establishment or to leave them impressed with the idea that they might persevere with impunity in a career of insolence and plunder."`,
        link: 'https://www.lawfareblog.com/remembering-bombardment-greytown',
        infoSrc: 'https://en.wikipedia.org/wiki/Bombardment_of_Greytown'
      },
    ],
  },
  '7-14': {
  ...
  '8-4': {
    ...
    'Birthdays': [
      ...
      {
        category: 'Birthdays',
        date: 'August 4th, 1839',
        title: 'Calixto García (1839 - 1898)',
        imgSrc: require('./assets/eventPhotos/Individuals/calixtoGarcia.jpg'),
        description: `Calixto García Íñiguez, born on this day in 1839, was a general in three separate Cuban uprisings for independence - the Ten Years' War, the Little War, and the War of 1895, which bled into the Spanish-American War.\n\nHe joined the Ten Years' War at the age of 18. Five years later, when surrounded by Spanish troops, he shot himself under the chin with a .45 caliber pistol to not give them the satisfaction of capturing him. Although the bullet went out of his forehead and knocked him unconscious, he survived; the wound left a great scar and gave him headaches for the rest of his life.\n\nGarcía played a key role in the ultimately successful War of 1895 and protested the subsequent lack of Cuban autonomy in the conclusion of the war (no Cuban was allowed to sign the terms of surrender and the Spanish leaders in Cuba were allowed to keep their posts in Santiago). He died of pneumonia at age 59 on December 11, 1898, while on a diplomatic mission in Washington, D.C. Today, his portrait is on the 50 Cuban peso banknote.`,
        link: 'https://www.historyisaweapon.com/defcon1/zinnempire12.html',
    ...
    'Revolution': [
      {
        ...
        title: 'U.S. Annexes Hawaii (1898)',
        imgSrc: require('./assets/eventPhotos/Events/hawaiiAnnexed.jpg'),
        description: `On January 17th, 1893, Queen Liliʻuokalani was overthrown by a group of predominantly foreign insurgents who sought American annexation of the Hawaiian islands. They successfully requested assistance from the U.S. government, who sent 162 sailors to occupy Oahu.\n\nOn this day in 1898, a formal ceremony at Iolani Palace was held to commemorate the annexation. Most of the 40,000 Native Hawaiians, including Liliʻuokalani and the royal family, shuttered themselves in their homes, protesting against what they considered an illegal transaction.\n\nThe revolution and subsequent annexation of Hawaii was the beginning of a long period of expansionism from the United States. Just three years later, the U.S. refused to withdraw troops from Cuba until their government ratified the Platt Amendment, which let Cuba only have "independence" under de facto American hegemony.`,
        link: 'https://learning.blogs.nytimes.com/2012/01/17/jan-17-1893-hawaiian-monarchy-overthrown-by-america-backed-businessmen/',
        infoSrc: 'https://en.wikipedia.org/wiki/Overthrow_of_the_Hawaiian_Kingdom'
      },
    ],
  ...
  '9-10': {
    ...
    'Labor': [
      {
        category: 'Labor',
        date: 'September 10th, 1897',
        title: 'Lattimer Massacre (1897)',
        imgSrc: require('./assets/eventPhotos/Events/lattimerMassacre.jpg'),
